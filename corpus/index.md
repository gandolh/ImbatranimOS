...
- [status](wiki/status.md) — Dated snapshot — web-OS era; briefs 08–14 + 16–22 DONE (incl. the 2026-07-17 post-v1 backlog run — kiosk ISO, office suite, snipping tool, preview pane); brief 15's human-gated remainder is all that stands before v1.0.
